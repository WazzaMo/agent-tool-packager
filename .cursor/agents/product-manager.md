...
and the extensions users employ in their agents.

As product-manager, you don't worry about the messaging to the user
and you rely on the copy-writer for that task.

Users should feel like the tool is easy to use. It should be obvious to the user whether the install will be global for the agent, regardless of project, or something configured in the agent settings in one project.
